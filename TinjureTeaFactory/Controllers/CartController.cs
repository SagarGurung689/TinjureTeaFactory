...
namespace TinjureTeaFactory.Controllers
{
    public class CartController : Controller
    {
        ...
        public CartController(TinjureContext context)
        {
        ...
        public IActionResult Clear()
        {
            ...
            // return Redirect("/"); redirect to home but different way

            if (HttpContext.Request.Headers["X-Requested-With"] != "XMLHttpRequest")
                return Redirect(Request.Headers["Referer"].ToString());  //redirect to same page
