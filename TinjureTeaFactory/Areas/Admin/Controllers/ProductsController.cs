...
namespace TinjureTeaFactory.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        private readonly IWebHostEnvironment webHostEnvironment; //adding dependecies 

        public ProductsController(TinjureContext context, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public async Task<IActionResult> Create(Product product)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (slug != null)
                {
                    ModelState.AddModelError("", "The product  aleardy exists.");
                    return View(product);
                }


                //nowing uploading images
